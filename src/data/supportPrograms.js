...
// 무료 법률 상담 — 이혼·양육·가정폭력 등 관계 문제 관련 무료 법률 지원
export const LEGAL_AID = [
  {
    name: '대한법률구조공단',
    tag: '무료 · 국번없이 132',
    desc: '이혼·양육·재산분할 등 가사·민사 법률 상담을 무료로 받을 수 있어요. 소득 요건을 충족하면 소송 대리도 지원해요.',
    tel: '132',
  ...
  },
  {
    name: '한국가정법률상담소',
    tag: '무료 · 1644-7077',
    desc: '부부·가족 갈등, 이혼, 가정폭력 등 가정 문제를 전문으로 무료 법률 상담을 제공해요.',
    tel: '1644-7077',
    link: 'https://lawhome.or.kr',
    linkLabel: '가정법률상담소',
  },
]
