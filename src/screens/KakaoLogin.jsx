    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <img src="/assets/cats/cat_pair.png" alt="쀼라인드" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
        </div>
      ...
      <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 12 }}>
        ...
        <p style={{ margin: 0, textAlign: 'center', fontSize: 12, color: 'var(--ink-muted)', lineHeight: 1.6 }}>
